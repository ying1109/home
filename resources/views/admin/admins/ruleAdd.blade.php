    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <p class="con_top">
                ...
                <a class="content_top" href="{{url('admin/admins/ruleAdd')}}">添加</a>
            </p>
            @if(count($errors) > 0)
                @if (is_object($errors))
            ...
            <form class="form-horizontal" action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="module" class="form-control">
                            ...
                            @foreach($list as $k => $v)
                                <option value="{{$v->id}}" {{old('module') == $v->id ? 'selected' : '' }}>=>{{$v->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="控制台">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="url" value="{{old('url')}}" placeholder="admin/homepage/console">
                    </div>
                </div>
