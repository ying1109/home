<div id="sidebar">
    <ul class="sidebar_menu">
        ...
        <li @if(CONTROLLER == 'admins') class="treeview active" @endif class="treeview" >
            ...
            <ul class="treeview_menu" @if(CONTROLLER == 'admins') style="display: block;" @endif>
                ...
                <li @if(METHOD == 'adminList') class="treeview active" @endif class="treeview">
                    <a href="{{url('admin/admins/adminList')}}" @if(substr(METHOD, 0, 5) == 'admin') class="active" @endif>
                        <i class="fa fa-heart-o fa-fw"></i>管理员列表
                    </a>
                </li>
                <li @if(METHOD == 'resetPwd') class="treeview active" @endif class="treeview">
